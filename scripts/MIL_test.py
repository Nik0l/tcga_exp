...
from mil.models import LogisticRegression, SVC, AttentionDeepPoolingMil
...
def mil_dl_test(path_to_data, n_epochs=10, batch_size=5, use_smaller_bags=True, n_patches_max=100):
